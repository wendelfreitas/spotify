...
const Player = ({
  ...
  <Container>
    ...
    <Current>
      {!!player.currentSong && (
        <Fragment>
          <img src={player.currentSong.thumbnail} alt={player.currentSong.author} />
          <div>
            {!!player.currentSong && <span>{player.currentSong.title}</span>}
            {!!player.currentSong && <small>{player.currentSong.author}</small>}
          </div>
        </Fragment>
      )}
    </Current>
